...
if opcao == "1":
    while laco == "S":
        ...
        titulo[8]) and (titulo[0]) == (titulo[9]):
            print(50 * "\33[93:2:1m-\33[m")
            print("\33[93:2:1mSEU TITULO DE ELEITOR NÃO É VALIDO!\33[m".center(50))
            print(50 * "\33[93:2:1m-\33[m")

        elif titulo[10] == str(titulo_digito) and titulo[11] == str(titulo_digito2):
            print(50 * "\33[93:2:1m-\33[m")
            print("\33[93:2:1mSEU TITULO DE ELEITOR É VALIDO!\33[m".center(50))
            print(50 * "\33[93:2:1m-\33[m")
        else:
            print(50 * "\33[93:2:1m-\33[m")
            print("\33[93:2:1mSEU TITULO DE ELEITOR NÃO É VALIDO!\33[m".center(50))
        ...
        if laco == "N":
            print(50 * "\33[93:2:1m-\33[m")
            print("\33[93:2:1mFunção Terminada\33[m".center(50))
            print(50 * "\33[93:2:1m-\33[m")
            break
elif opcao == "2":
               # escolher o estado
    ...
    print(str(f"\33[93:2:1m{numero}\33[m").center(50).replace(",", ""))
    print(50 * "\33[93:2:1m-\33[m")
else:
    print(50 * "\33[93:2:1m-\33[m")
